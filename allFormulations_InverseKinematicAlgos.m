%% THIS FILE INCLUDES ALL VERSIONS OF INVERSE KINEMATIC ALGORITHMS DEVELOPED FOR HUMAN ARM
% ONLY FOR TRIAL AND ERROR AND EXPERIMENTATION

%% THE FINAL SELECTED INVERSE KINEMATIC ALGO CAN BE FOUND in 'calcInverseKinematic.m'
...
% 
% trajPos = data.data.part(2).dv(35).trajectory;
% % trajPos = data.data.part(2).trajPos{35}; % Example for participant 2, trial 35
...
% figure;
% plot(rad2deg(joint_angles_over_time));
% xlabel('Step');
